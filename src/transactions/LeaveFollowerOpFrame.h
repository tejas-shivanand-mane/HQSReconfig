...
class LeaveFollowerOpFrame : public OperationFrame
{
    LeaveFollowerResult&
    innerResult()
    {
        return mResult.tr().leaveFollowerResult();
    }
    LeaveFollowerOp const& mLeaveFollower;
  ...
  public:
    LeaveFollowerOpFrame(Operation const& op, OperationResult& res,
    ...
    static LeaveFollowerResultCode
    getInnerCode(OperationResult const& res)
    {
        return res.tr().leaveFollowerResult().code();
    }
};
}
