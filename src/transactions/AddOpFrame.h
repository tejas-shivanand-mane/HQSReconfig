...
class AddOpFrame : public OperationFrame
{
    AddResult&
    innerResult()
    {
        return mResult.tr().addResult();
    }
    AddOp const& mAdd;
  ...
  public:
    AddOpFrame(Operation const& op, OperationResult& res,
    ...
    static AddResultCode
    getInnerCode(OperationResult const& res)
    {
        return res.tr().addResult().code();
    }
};
}
